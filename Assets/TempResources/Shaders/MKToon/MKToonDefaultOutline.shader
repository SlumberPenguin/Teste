Shader "Hidden/MK/Toon/Default Outline"
{
	Properties
	{
		...
		[Enum(MKZWrite)] _OutlineZWrite("Outline Z-Buffer", int) = 1.0
		...
		[Toggle] _UseSelect("Select", int) = 0
		...
		[HideInInspector] _MKEditorShowSelectBehavior("Select Behavior", int) = 0
	}
	SubShader
	{
		LOD 300
		...
		Pass
		{
			...
			#pragma shader_feature __ _MK_SELECT
